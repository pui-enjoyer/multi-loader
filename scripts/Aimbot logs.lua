local aimbotlog_enable = ui.new_checkbox("LUA", "A", "Advanced aimbot logging")
local on_fire_enable = ui.new_checkbox("LUA", "A", "Fire log")
local on_fire_colour = ui.new_color_picker("LUA", "A", "Fire log", 147, 112, 219, 255)
local on_miss_enable = ui.new_checkbox("LUA", "A", "Miss log")
local on_miss_colour = ui.new_color_picker("LUA", "A", "Miss log", 255, 253, 166, 255)
local on_damage_enable = ui.new_checkbox("LUA", "A", "Damage log")
local on_damage_colour = ui.new_color_picker("LUA", "A", "Damage log", 100, 149, 237, 255)

...
local notify = (function()
    ...
    local k = (function()
        local d = {}
d.rec = function(x, y, w, h, r, g, b, a, radius)
    radius = math.floor(math.min(w / 2, h / 2, radius)) -- ограничим и округлим
    ...
    -- углы
    renderer.circle(x + radius, y + radius, r, g, b, a, radius, 180, 0.25) -- верх.лево
    renderer.circle(x + w - radius, y + radius, r, g, b, a, radius, 90, 0.25) -- верх.право
    renderer.circle(x + w - radius, y + h - radius, r, g, b, a, radius, 0, 0.25) -- низ.право
    renderer.circle(x + radius, y + h - radius, r, g, b, a, radius, -90, 0.25) -- низ.лево
end
...
-- рисуем фон с учетом скругления
k.rec(s, t, q, r, bg_r, bg_g, bg_b, bg_a, rounding)
...
return (function(tbl)
    ...
    local category = ui.new_combobox("aa", "anti-aimbot angles", prefix("LS upgrade" .. rgba(69,169,155,255," " .. (getbuild() == "upgrade" and "upgrade" or ""))), {" home", " rage", " anti aimbot", " visuals & misc", "✦ config"})
    ...
    menu = {
        ...
        [" visuals & misc"] = {
            ...
            ["visuals"] = {
                buildzzinfo = ui.new_label("aa", "anti-aimbot angles", prefix"-------------- WATERMARK -------------"),
                wtext = ui.new_combobox("aa", "anti-aimbot angles", prefix("watermark"), {" luasense ", "luasense beta", "luasync.max2", "luasync.max", " luasense", "luasense ", "luasense", "w3LLy$eN$E", "custom"}),
                ...
                watermark_x_offset = ui.new_slider("aa", "anti-aimbot angles", prefix("watermark x offset"), -1920, 1080, 0, true, "px"),
                watermark_y_offset = ui.new_slider("aa", "anti-aimbot angles", prefix("watermark y offset"), -1920, 1080, 0, true, "px"),
                ...
                wfont = ui.new_combobox("aa", "anti-aimbot angles", prefix("watermark font"), {"normal", "small", "bold"}),
                ...
                buildinfo = ui.new_label("aa", "anti-aimbot angles", prefix"----------------- OTHER -----------------"),
                ...
                notrounding = ui.new_slider("aa", "anti-aimbot angles", prefix("notify rounding"), 0, 13, 10, true, "px"),
        ...
        ["✦ config"] = {
            config_selector = ui.new_combobox("aa", "anti-aimbot angles", prefix("select config"), { "test", "aggressive delayed jitter", "safe delayed jitter", "aggressive jitter", "safe jitter", "perfect jitter", "perfect delay jitter"}),
...
elseif selected_config == "test" then
                         tbl = json.parse([[{"LUASENSE":{"duck moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-17,"left":43,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-17,"left":43,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"extra":{"builder":{"builder":"hide shot","team":"t"},"submenu":"builder","features":{"backstab":"forward","legit":"off","roll":0,"fix":{},"defensive":"off","distance":300,"fixer":"default","states":{}},"keybinds":{"type_freestand":"jitter","type_manual":"static","keys":["manual","freestand"],"disablers":["manual"]}},"slow motion":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air duck":{"t":{"normal":{"right":-20,"jitter_slider":0,"yaw":0,"method":"luasense","left":47,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":-17,"left":49,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":-20,"jitter_slider":0,"yaw":0,"method":"luasense","left":47,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":-17,"left":49,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"fake lag":{"t":{"normal":{"right":20,"jitter_slider":0,"yaw":0,"method":"luasense","left":-20,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-24,"left":48,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":20,"jitter_slider":0,"yaw":0,"method":"luasense","left":-20,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-24,"left":48,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air":{"t":{"normal":{"right":-16,"jitter_slider":0,"yaw":0,"method":"luasense","left":42,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":-19,"method":"luasense","left":36,"defensive":"off","timer":89,"antibf":"no"}},"ct":{"normal":{"right":-16,"jitter_slider":0,"yaw":0,"method":"luasense","left":42,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":-19,"method":"luasense","left":36,"defensive":"off","timer":89,"antibf":"no"}}},"global":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-29,"left":25,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-29,"left":25,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"duck":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":-37,"method":"luasense","left":37,"defensive":"luasense","timer":150,"antibf":"yes"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":-37,"method":"luasense","left":37,"defensive":"luasense","timer":150,"antibf":"yes"}}},"hide shot":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":39,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":39,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-30,"left":40,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-30,"left":40,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"standing":{"t":{"normal":{"right":-35,"jitter_slider":57,"yaw":0,"method":"default","left":22,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["yaw","left right"],"body_slider":0},"advanced":{"right":-20,"left":39,"trigger":"c: experimental","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":41,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":-21,"method":"simple","left":45,"defensive":"luasense","timer":112,"antibf":"yes"}},"ct":{"normal":{"right":-35,"jitter_slider":57,"yaw":0,"method":"default","left":22,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":["yaw","left right"],"body_slider":0},"advanced":{"right":-20,"left":39,"trigger":"c: experimental","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":41,"fake":60,"yaw":0,"defensive":"off","mode":["left right"],"luasense":2},"disabled":{},"auto":{"right":-21,"method":"simple","left":45,"defensive":"luasense","timer":112,"antibf":"yes"}}}}}]])
...
for i, v in next, menu do
    ...
    local killsay_messages = {
        ...
        "неверлуз фывлфывропф лучший чит в мире ну как бы всех рвет в хвх но тока в твоих снах НАУД",
        "neverlose fîvlîfîvropf cel mai tare cheat adica zice ca rupe tot in hvh da numa in visele tale NAUD",
        "skeet fuckin garbage paste burn ur pc fail every hs like free cheat from dialup days NAUD",
        "скит фывлфывропф самый крутой чит ой то есть хрень делает тебя царь хвх но в мечтах НАУД",
        "keet fîvlîfîvropf cheatu numaru unu cica te face rege in hvh da doar in capu tau NAUD",
        "smecher cu parfum de DAMA",
        "haha ragalie manca pula ca lady badika haha0))))))",
        "✦ config by > Pro✦ config.net <",
        "✦ config by > Pro✦ config.Net <",
        "lady badika mad and block me aka pufarino badika nicoleta ragalie((((",
        "Ёбаный рот, нахуй, bang up!",
        "Аф, аф, аф, аф Аф-аф, yeah, аф-аф Киса потеряла интерес со мной Я хочу оставить этот день вчера У меня с 14 лет запой, МОЙ САМЫЙ ЛУЧШИЙ ДЕНЬ ЭТО НИ- КО-ГДА",
        ...
        "stefanbomba ce smardoi te crezi in hvh da te rupe kamel cu cfg de pe Pro✦ config.net",
        ...
        "insomnia ba trezirea te rupe adi luca cu cfg de pe Pro✦ config.net in hvh",
...
-- downloaded from github.com/pui-enjoyer/multi-loader/scripts
